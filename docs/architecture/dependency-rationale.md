...
| `@industrial-learn/content-review-workflow` | `packages/content-system`           | Validates static review records and exact-version publication authority using the shared governance rules. | Internal workspace dependency only; prevents validator and runtime policy drift.                     |
