-- Preserve migration 0015's explicit Platform Owner read-only content oversight.
-- Do not add the owner to is_content_staff: that would inherit write permissions.
